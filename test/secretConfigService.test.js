...
describe("SecretConfigService", () => {
  ...
  const testMongoUriNamePostfix = "MONGODB_URI_TEST";
  ...
  beforeEach(() => {
    ...
    process.env.MONGODB_URI_NAME_POSTFIX = testMongoUriNamePostfix;
  });
  ...
  describe("Constructor", () => {
    it("should exit process if JWT_SECRET_NAME_POSTFIX or MONGODB_URI_NAME_POSTFIX is not set", () => {
      const originalExit = process.exit;
      const mockExit = jest.fn();
      process.exit = mockExit;
      delete process.env.JWT_SECRET_NAME_POSTFIX;
      delete process.env.MONGODB_URI_NAME_POSTFIX;
      ...
      expect(mockLogger.error).toHaveBeenCalledWith(
        "Environment variable JWT_SECRET_NAME_POSTFIX or MONGODB_URI_NAME_POSTFIX is not set"
      );
